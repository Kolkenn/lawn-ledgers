    ...
    <div className="min-h-screen bg-emerald-900 p-4">
      ...
      <div className="flex items-center justify-center w-full h-full">
        <div className="bg-white p-8 rounded-xl shadow-lg max-w-md w-full">
          <h1 className="text-3xl font-bold text-center text-gray-800 mb-6">{t('createAccount')}</h1>
          
          <div className="my-4">
            <p className="text-center text-sm text-gray-500 mb-2">{t('signUpWith')}</p>
          ...
          <form onSubmit={handleSignUp} noValidate>
            ...
            <FormField 
              id="confirmPassword" label={t('confirmPasswordLabel')} type="password" placeholder="••••••••"
